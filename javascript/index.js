...
function selectText() {
    ...
    switch(newChoice) {
        ...
        break;
        case 'austen':
        chosenText = austenText;
        break;
        case 'calvino':
        chosenText = calvinoText;
        break;
        case 'spencer':
        chosenText = spencerText;
        break;
        case 'homer':
